...
//	@MockBean
	...
	void otpGenerateTest() {
		OtpRequestModel otpModel = OtpRequestModel.builder().channel("app").digit("6").duration("180").mobile("6070223318")
				.operationType("generate").startTime("2022-12-18 12:43:47").countryCode("91").processName("PAYMENTS").build();
	...
	void otpValidateTest() {
		...
		OtpRequestModel otpModel2 = OtpRequestModel.builder().channel("app").digit("6").generatedOtp(otpResponse.getOtp())
				.duration("180").mobile("6070223318").operationType("validate").startTime("2022-12-18 12:43:47").countryCode("91").processName("PAYMENTS").otpId(otpResponse.getOtpId()).build();
